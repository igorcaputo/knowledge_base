...
begin
  ...
  try
    ...
    qry.SQL.Text := 'select AD_MAT as MATRICULA,AD_NOME as NOME, AD_DTINICIO AS INICIO, AD_DTFIM AS FIM, date('+quotedstr('dd/mm/yyyy')+',AD_DTRETORNO) as RETORNO from BLOQUEIO_AD';
     a := qry.SQL.text;
